...
const PRODUCTS = [
  ...
  { id:23, name:'Piruleta Corazón Cerdán', cat:'caramelos', art:'lolly', img:'images/productos/piruletas-corazon-110-ud-cerdan.jpg', price:0.25, meta:'Unidad suelta' },
  { id:24, name:'Smint Tabs Menta 1 cajita', cat:'caramelos', art:'wrapped', img:'images/productos/smint-tabs-menta-12-ud.jpg', price:1.99, meta:'Unidad suelta' },
  { id:25, name:'Cereza envuelta gragea 80 g Fini', cat:'gominolas', art:'bear', img:'images/productos/cereza-envuelta-gragea-80-g-12-ud-fini.jpg', price:0.99, meta:'Unidad suelta' },
  { id:26, name:'Orbit Refreshers Hierbabuena 1 ud', cat:'chicles', art:'gum', img:'images/productos/orbit-refreshers-hierbabuena-16-ud.jpg', price:1.49, meta:'Unidad suelta' },
  { id:27, name:'Sobre Soda Unicornios Fresa Plátano Cerdán', cat:'caramelos', art:'wrapped', img:'images/productos/sobres-soda-unicornios-fresa-platano-40-ud-cerdan.jpg', price:0.35, meta:'Unidad suelta' },
  { id:28, name:'Orbit Refreshers Tropical 1 ud', cat:'chicles', art:'gum', img:'images/productos/orbit-refreshers-tropical-16-ud.jpg', price:1.49, meta:'Unidad suelta' },
  { id:29, name:'Oreo doble crema 157 g', cat:'chocolate', art:'choc', img:'images/productos/oreo-doble-crema-157-g-16-ud.jpg', price:1.99, meta:'Unidad suelta' },
  { id:30, name:'Sobre Soda Dinos Lima Limón Cerdán', cat:'caramelos', art:'wrapped', img:'images/productos/sobres-soda-dinos-lima-limon-40-ud-cerdan.jpg', price:0.35, meta:'Unidad suelta' },
  { id:31, name:'Barrita Jungly 34 g Nestlé', cat:'chocolate', art:'choc', img:'images/productos/barrita-jungly-34-g-30-ud-nestle.jpg', price:0.79, meta:'Unidad suelta' },
  { id:32, name:'Snack Crunch 33 g Nestlé', cat:'chocolate', art:'choc', img:'images/productos/snack-crunch-33-g-30-ud-nestle.jpg', price:0.79, meta:'Unidad suelta' },
];
